      ...
      >
        <div className="w-full max-w-[1440px] mx-auto px-4 md:px-[60px]">
          <div className="max-w-[500px]">
            ...
            <h1 className="text-white text-[40px] md:text-[58px] leading-[55px] md:leading-[80px] font-bold mb-6">
              NEW COLLECTION
            </h1>
            ...
            <Link
              to="/shop"
              className="inline-block bg-[#2DC071] text-white text-[24px] font-bold px-[40px] py-[15px] rounded-[5px]"
            >
              SHOP NOW
            </Link>
          </div>
